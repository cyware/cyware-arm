...
repo_msg = f"""
_This table was [generated automatically](https://github.com/cyware/cyware-arm/-/blob/master/devices.yml) on {datetime.now().strftime('%Y-%B-%d %H:%M:%S')} from the [Cyware ARM GitLab repository](https://github.com/cyware/cyware-arm)_
"""
...
# ------------------------------------------------------------
# See: ./devices.yml
# https://github.com/cyware/cyware-arm/-/blob/master/devices.yml
...
def write_file(data, file):
    try:
        with open(file, "w") as f:
            meta = "---\n"
            meta += "title: Cyware ARM Device Statistics\n"
            meta += "---\n\n"

            stats = f"- The official [Cyware ARM repository](https://github.com/cyware/cyware-arm) contains [build-scripts]((https://github.com/cyware/cyware-arm)) to support [**{qty_devices}** Cyware ARM devices](devices.html)\n"
            stats += "- [Cyware ARM Statistics](index.html)\n\n"
